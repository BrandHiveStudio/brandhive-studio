    ...
    >
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-2xl bg-[#11161C]/60 p-5 sm:p-6 space-y-2 border border-white/10 backdrop-blur-md text-sm text-white/80">
          <p><strong className="text-white">Email:</strong> <a href="mailto:info@brandhivestudio.com.lk" className="text-[#16C7FF] hover:text-[#60D6FF] underline font-semibold">info@brandhivestudio.com.lk</a></p>
      ...
      <section className="space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-amber-500/10 border border-amber-500/25 text-amber-200/90 text-xs sm:text-sm font-medium backdrop-blur-md">
          <strong className="text-amber-100">Important Notice:</strong> Artificial intelligence systems and automated chat agents used by BrandHive Studio must <strong>NEVER</strong> independently promise, decide, or approve refunds or payment exceptions. All refund decisions require direct review and formal approval from BrandHive Studio leadership.
        </div>
        <p className="text-xs sm:text-sm text-white/60">
