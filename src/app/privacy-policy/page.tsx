    ...
    >
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          <strong className="text-[#0F172A]">www.brandhivestudio.com.lk</strong>. We provide premium branding, digital design, website development, UI/UX engineering, and growth marketing solutions for ambitious companies and organizations.
        </p>
        <p>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-3 pl-4 border-l-2 border-[#12BDF7]">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-slate-700">
            <li><strong>Contact Details:</strong> Your full name, business or personal email address, phone number, and WhatsApp contact.</li>
            <li><strong>Business & Project Details:</strong> Company or brand name, industry, current website URL, project scope, desired timelines, and approximate budget ranges.</li>
            <li><strong>Communication Content:</strong> Project briefs, design reference materials, specific inquiries, and general correspondence shared with our team.</li>
          </ul>
        </div>
        ...
        <div className="space-y-3 pl-4 border-l-2 border-slate-300">
          ...
          <p className="text-xs text-slate-500">
            Note: Analytics tracking scripts are strictly subject to your consent choices in accordance with our <Link href="/cookie-policy" className="text-[#0284C7] underline font-semibold">Cookie Policy</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-5 space-y-2 text-slate-700">
          <li><strong>Project Consultation & Scoping:</strong> Evaluating incoming project specifications, crafting accurate quotations, and preparing tailored proposals.</li>
          <li><strong>Service Delivery:</strong> Designing, engineering, and delivering client projects according to agreed briefs.</li>
          <li><strong>Client Communication:</strong> Responding to client enquiries, scheduling meetings, and sending milestone or administrative updates.</li>
          <li><strong>Invoicing & Records:</strong> Processing invoices, tracking milestone payments, and fulfilling accounting requirements.</li>
          <li><strong>Website Performance:</strong> Analyzing traffic trends to diagnose technical issues, optimize loading speeds, and enhance overall user experience.</li>
          <li><strong>Security & Compliance:</strong> Protecting our website, assets, and visitors against fraudulent activity or unauthorized system abuse.</li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          When you fill out our contact form at <strong className="text-[#0F172A]">/contact</strong>, the information you supply is transmitted securely to our designated communications channels.
        </p>
        <p>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          <Link href="/cookie-policy" className="text-[#0284C7] underline font-semibold">
            Cookie Policy
          </Link>{" "}
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          <a href="mailto:info@brandhivestudio.com.lk" className="text-[#0284C7] font-semibold underline">
