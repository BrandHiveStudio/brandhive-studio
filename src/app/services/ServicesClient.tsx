              ...
              <div className="lg:col-span-5 flex flex-col sm:flex-row items-center justify-center lg:justify-end gap-5 sm:gap-6 w-full">
                ...
                >
                  <Link href="/contact" className="inline-block rounded-full outline-none focus:outline-none">
                    <Button
                      size="lg"
                      className="cta-sweep-auto rounded-full bg-gradient-to-r from-[#16C7FF] to-[#0096C7] text-[#050608] font-bold px-8 py-6 shadow-md transition-all duration-300 text-center cursor-pointer"
                    >
                      Start a Project
                    </Button>
                  </Link>
